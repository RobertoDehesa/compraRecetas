...
//  recetas
//
//  Created by Roberto Dehesa  on 27/12/14.
//  Copyright (c) 2014 Roberto Dehesa. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ModelDataBase", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("recetas.sqlite")
        //imprimimos la ruta de la base de datos .sqlite que genera
        println(url)
